...
#nm.scan(hosts=targets, arguments='-n -sP -PE -PA21,23,80,3389')
...
print('----------------------------------------------------')
nmp = nmap.PortScannerYield()
for i in nmp.scan(target,'20-443'):
	print(i)
#
#print('----------------------------------------------------')
...
#nma.scan(hosts='192.168.43.201-210', arguments='-sP', callback=callback_result)
